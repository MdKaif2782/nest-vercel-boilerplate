...
export class ExpenseService {
  ...
  private mapToResponseDto(expense: any): ExpenseResponseDto {
    return {
      ...
      salaryId: expense.salaryId,
      employeeAdvanceId: expense.employeeAdvanceId,
      investorPaymentId: expense.investorPaymentId,
      purchaseOrderPaymentId: expense.purchaseOrderPaymentId,
