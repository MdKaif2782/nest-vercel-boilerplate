...
\\multicolumn{7}{r}{\\textbf{Total Amount:}} & \\textbf{${formatCurrency(
      totalAmount,
    )}} \\\\\\hline
\\end{longtable}
...
\\item ${escapeLatex(
      quotation.deliveryTerms || `Delivery: Within ${quotation.deliveryDays || 7} days`,
    )}
